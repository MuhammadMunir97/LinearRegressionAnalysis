...
Year, Status_0, Status_1, percentage.expenditure, BMI, Polio, Diphtheria, HIV.AIDS
...
model1 <- lm(Life.expectancy ~ Year+Status_0+percentage.expenditure+BMI+Polio+Diphtheria+HIV.AIDS, data = data)

model2 <- lm(Life.expectancy ~ Year+Status_1+percentage.expenditure+BMI+Polio+Diphtheria+HIV.AIDS, data = data)
```
