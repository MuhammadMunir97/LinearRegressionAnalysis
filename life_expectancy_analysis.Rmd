...
life_expectancy_box_cox <- boxcox(fit, lambda = seq (-2, 2, 1/10))
life_expectancy_box_cox$x[which.max (life_expectancy_box_cox$y)]

transformed_life_expectancy <- life_expectancy_data
transformed_life_expectancy$Life.expectancy <- transformed_life_expectancy$Life.expectancy^2

transformed_fit <- lm(transformed_life_expectancy$Life.expectancy~transformed_life_expectancy$Status+transformed_life_expectancy$percentage.expenditure+transformed_life_expectancy$BMI+transformed_life_expectancy$Polio+transformed_life_expectancy$Diphtheria+transformed_life_expectancy$HIV.AIDS)
